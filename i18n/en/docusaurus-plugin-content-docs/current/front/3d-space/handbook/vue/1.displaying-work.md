...
```vue title="src/1. isplaying-work/App.vue"
<template>
<template>
...
```html title="rc/1.displaying-work/index.html"
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    // Highlight-start
     ...
     href="https://cdn.jsdelir.net/npm/bootstrap-icons1.5.0/font/bootstrap-icons.css" rel="stylesheet">
    //highlight-end
    <style>
        * {
            margin: 0;
...
```vue title="rc/1.displaying-work/ModeController.vue"
<template>

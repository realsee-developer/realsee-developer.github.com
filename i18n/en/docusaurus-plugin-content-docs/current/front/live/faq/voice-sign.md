...
***/
// highlight-start
const getVoiceSignn = async (opts) => {// ops) opts are shaped, and sdk will be injected automatically when calling language signature methods without having to be processed by the business party.
    // Highlight-end    
    ...
    return await request('getRtcSign', {
        ...
        room_id: opts.roomId,
        user_id: opts.userId
    }).then((res) => { // Get the voice signature and other information returned by the backend, and follow the sdk requirements, just return and go out
        return {
